...
public class FrameKOPrivateConnectionResponseReader implements Reader{
    ...
    public FrameKOPrivateConnectionResponseReader(ByteBuffer bb) {
    ...
    public Object get() {
        ...
        return new FramePrivateConnectionResponse(requester, target, FramePrivateConnectionResponse.KO_PRIVATE);
    }
